<template>
    <div>
       ...
       <div class="anquan" @click="toAnauan()">
               <span>食品监督安全公示</span>
               <span>企业认证详情></span>
       </div>
       <div class="xhuok">
       ...
       <div id="All_bottom">
           ...
           <p>营业时间:{{data1.opening_hours}}</p>
           <p @click="clickZz"><span>营业执照</span><span class="YouA" >></span></p>
           <p @click="clickZz"><span>餐饮服务许可证</span><span class="YouA" >></span></p>
       </div>
       <div class="zhezao" v-if="show" @click="clickZz"></div>
    </div>
</template>
<script>
export default {
    ...
    methods: {
        huoquAll(){
            this.data1=this.$store.state.allContent;
